...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#7aa6da", "#1d1f21", "#1d1f21" },
	[SchemeSel]  = { "#1d1f21", "#7aa6da",  "#7aa6da"  },
};
...
static const char *pmenucmd[] = { "/home/moritz/.scripts/powermenu",	NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,				XK_t,      spawn,          {.v = pmenucmd } },
